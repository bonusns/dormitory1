...
# Form implementation generated from reading ui file 'red_contract_2.ui'
#
...
class Ui_red_contract_2(object):
    ...
    def setupUi(self, red_contract_2):
        ...
        red_contract_2.setMinimumSize(QtCore.QSize(680, 400))
        red_contract_2.setMaximumSize(QtCore.QSize(680, 400))
        self.centralwidget = QtWidgets.QWidget(red_contract_2)
       ...
       # self.back_to_red_client_btn.clicked.connect(self.del_buff)
        ...
        red_contract_2.setStatusBar(self.statusbar)

        self.retranslateUi(red_contract_2)
    ...
    def retranslateUi(self, red_contract_2):
        ...
        red_contract_2.setWindowTitle(_translate("red_contract_2", "Выбранный договор"))
...
if __name__ == "__main__":
    ...
    red_contract_2 = QtWidgets.QMainWindow()
    ui = Ui_red_contract_2()
    ui.setupUi(red_contract_2)
    red_contract_2.show()
    sys.exit(app.exec_())
