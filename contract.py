...
class Ui_contract(object):
    ...
    def setupUi(self, contract):
        ...
        self.facilities_btn = QtWidgets.QPushButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.facilities_btn.sizePolicy().hasHeightForWidth())
        self.facilities_btn.setSizePolicy(sizePolicy)
        self.facilities_btn.setMinimumSize(QtCore.QSize(150, 40))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(135, 206, 235))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.Window, brush)
        self.facilities_btn.setPalette(palette)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.facilities_btn.setFont(font)
        self.facilities_btn.setStyleSheet("background-color: rgb(135, 206, 235);")
        self.facilities_btn.setObjectName("facilities_btn")

        self.facilities_btn.clicked.connect(self.openHelp)
        self.facilities_btn.clicked.connect(contract.close)

        self.gridLayout.addWidget(self.facilities_btn, 1, 2, 1, 1)
        ...
        self.cost_btn.clicked.connect(self.openCost)
    ...
    def retranslateUi(self, contract):
        ...
        self.facilities_btn.setText(_translate("contract", "Льготы"))
